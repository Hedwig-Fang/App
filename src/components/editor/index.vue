<template>
    <div v-loading="loading">
        ...
        <div :class="[$style.container]">
            ...
            >
                <div data-text="左侧" :class="$style.toolBarWrap">
                ...
                <div data-text="中间" :class="[$style.contentBox]">
                    <el-form
                        style="height: 100%"
                        :model="rootFormData"
                        v-bind="formProps"
                ...
                <div data-text="右侧" :class="$style.rightForm">
...
import componentWithDialog from './components/component-with-dialog';
import { openNewPage } from './utils/url.js';
