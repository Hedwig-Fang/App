...
import componentViewPort from '../viewComponents/viewPort'
import componentTag from '../viewComponents/tag'
import componentEditor from '../viewComponents/editor'
/**
 * hidden 隐藏，不显示在工具栏
    ...
    componentList: [
      {
        ...
        componentPack: componentViewPort
      },
      {
        title: '添加标签',
        isCustom: true,
        componentPack: componentTag
      },
      {
        title: '富文本',
        isCustom: true,
        componentPack: componentEditor
      },
    ]
  },
  {
